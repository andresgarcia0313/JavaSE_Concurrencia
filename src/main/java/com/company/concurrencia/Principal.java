...
import java.util.concurrent.ExecutorService;// Interfaz que representa un pool de hilos permitiendo la funcionalidad de ejecutar tareas de forma concurrente
import java.util.concurrent.Executors;// Clase que proporciona métodos estáticos para crear diferentes tipos de pools de hilos
